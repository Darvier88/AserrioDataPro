 ...
 * @author Zambrano
 */
public class ModificarAsistenteOperarioController implements Initializable {
    ...
    public static void cargarVistaConEmpleado(Empleado empleado) throws IOException {
        FXMLLoader loader = new FXMLLoader(App.class.getResource("modificarAsistenteOperario.fxml"));
        Parent root = loader.load();

        ModificarAsistenteOperarioController controller = loader.getController();
        controller.setEmpleado(empleado);

        App.setRoot("modificarAsistenteOperario");
    }
    ...
    private boolean actualizarEmpleadoEnBD(Empleado e) {
        String sql = "{CALL ActualizarAsistente(?, ?, ?, ?, ?, ?)}";
