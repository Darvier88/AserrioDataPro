 ...
 */
public class AñadirOperarioController implements Initializable {
    ...
    private boolean insertarOperarioEnBD(Empleado e) {
        String sql = "{call InsertOperario(?, ?, ?, ?, ?, ?)}"; // Llamada al procedimiento almacenado
    ...
    private void añadir(ActionEvent event) {
        ...
        if (insertarOperarioEnBD(nuevoE )) {
            // Limpiar los campos después de añadir
            añadirBase.clearFields();
        } else {
            mostrarError("No se pudo añadir el operario a la base de datos.");
        }
        ...
        e.printStackTrace();
        mostrarError("Ocurrió un error al intentar añadir el operario.");
    }
    }
