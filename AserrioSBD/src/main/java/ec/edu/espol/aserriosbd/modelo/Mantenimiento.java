...
public class Mantenimiento {
    ...
    private Date fecha;            // Fecha del mantenimiento

    public Mantenimiento(int id, String idOperario, int codigoMaquinaria, String idSecretaria, String detalle, Date fecha) {
        this.id = id;
